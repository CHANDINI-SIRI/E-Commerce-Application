...
// --- ROOT ROUTE ---
// Instead of a 404 error, this lets us instantly verify the backend is online!
app.get("/", (req, res) => {
    res.send("E-Commerce REST API is running smoothly in the cloud.");
});

// --- FORCE SEED ENDPOINT ---
// Running database seeds on startup crashes serverless functions. 
// Moving it to a manual route makes it 100% stable!
app.get("/api/seed", async (req, res) => {
    try {
        ...
        res.json({ message: "Database successfully seeded with absolute web URLs!" });
    } catch (error) {
